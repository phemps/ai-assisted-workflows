#!/usr/bin/env python3
"""
Validation utilities for SuperCopilot analysis scripts.
"""
...
def validate_target_directory(target_path: str) -> Tuple[bool, Optional[str], Optional[Path]]:
...
def validate_file_access(file_path: Path, max_size_mb: int = 10) -> Tuple[bool, Optional[str]]:
...
def validate_environment_config() -> Dict[str, Any]:
    ...
    int_configs = {
        'MAX_FILES': (50, 1, 1000),
        'MAX_FILE_SIZE': (1048576, 1024, 100 * 1024 * 1024),  # 1MB default, 1KB min, 100MB max
        'DAYS_BACK': (30, 1, 365),
        'MAX_COMMITS': (50, 1, 500),
        'ANALYSIS_TIMEOUT': (300, 10, 3600),  # 5 minutes default, 10 sec min, 1 hour max
    }
