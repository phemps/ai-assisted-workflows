...
from .integration.orchestration_bridge import OrchestrationBridge, MessageType
...
def create_orchestration_bridge(project_root: str = ".") -> OrchestrationBridge:
    """
    ...
    """
    return OrchestrationBridge(project_root)
